...
public class Mail extends javax.swing.JFrame {
    ...
    public static final String USERNAME = "jeremy.bory@st2msi.net";
    public static final String PASSWORD = "rThH[%#j&R-g";
    ...
    public Mail(String destinataire)throws Exception  {
        ...
        for (int i = 1; i < messages.length; i++) {
            ...
            int i = 0;
            while( rs.next() ){
                if(rs.getString("expediteur").equals("jeremy.bory@st2msi.net")){
                    uiTable = (DefaultTableModel) jTable2.getModel();
                } else {
